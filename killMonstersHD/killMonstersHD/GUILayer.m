...
- (id) init
{
    if((self = [super init]))
    {
        ...
        lifes.position = ccp(25, GameHeight - 30);
        lifes.scale = 1.2;
        [self addChild: lifes];
        
        CCSprite *coins = [CCSprite spriteWithFile: @"coins.png"];
        coins.position = ccp(115, GameHeight - 31);
        coins.scale = 1.3;
        [self addChild: coins];
        
        scoreLabel = [CCLabelBMFont labelWithString: @"0" fntFile: @"font40.fnt"];
        scoreLabel.position = ccp(150, GameHeight - 36);
        scoreLabel.anchorPoint = ccp(0, 0.5);
        [self addChild: scoreLabel];
        
        lifesLabel = [CCLabelBMFont labelWithString: @"5" fntFile: @"font40.fnt"];
        lifesLabel.position = ccp(70, GameHeight - 36);
        ...
        pauseBtn.scale = 1.2;
        pauseBtn.position = ccp(GameWidth * 0.96, GameHeight * 0.94);
...
- (void) showPauseMenu
{
    if(IsGameActive == YES)
    {
        ...
        pauseLabel = [CCLabelBMFont labelWithString: @"PAUSED" fntFile: @"font64.fnt"];
        ...
        yourScoreLabel = [CCLabelBMFont labelWithString: @"" fntFile: @"font40.fnt"];
        ...
        [yourScoreLabel runAction: 
         [CCEaseBackOut actionWithAction:
          [CCMoveTo actionWithDuration: 0.5f 
                              position: ccp(GameCenterX, GameCenterY + 30)
           ]
          ]
         ];
        ...
        [pauseLabel runAction: 
         [CCEaseBackOut actionWithAction:
          [CCMoveTo actionWithDuration: 0.5f 
                              position: ccp(GameCenterX, GameCenterY + 100)
           ]
          ]
         ];
...
- (void) showGameOverMenu
{
    if(IsGameActive == YES)
    {
        ...
        pauseLabel = [CCLabelBMFont labelWithString: @"GAME OVER" fntFile: @"font64.fnt"];
        pauseLabel.color = ccc3(255, 0, 0);
        pauseLabel.position = ccp(GameCenterX, GameHeight + 30);
        [self addChild:pauseLabel z:kZMenu];
        ...
        [yourScoreLabel runAction: 
         [CCEaseBackOut actionWithAction:
          [CCMoveTo actionWithDuration: 0.5f 
                              position: ccp(GameCenterX, GameCenterY + 85)
           ]
          ]
         ];
        ...
        [pauseLabel runAction: 
         [CCEaseBackOut actionWithAction:
          [CCMoveTo actionWithDuration: 0.5f 
                              position: ccp(GameCenterX, GameCenterY + 155)
           ]
          ]
         ];
